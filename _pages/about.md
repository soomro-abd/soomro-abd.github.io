...
1. [very accurately synchronized time in NB-IoT devices](https://dl.acm.org/doi/full/10.1145/3774906.3800502)
2. [found vulnerabilities in the `LinuxPTP` stack](https://ieeexplore.ieee.org/abstract/document/11281713)
3. [secured timing systems in datacenters](https://ieeexplore.ieee.org/abstract/document/11392079)
